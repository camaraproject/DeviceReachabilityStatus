...
Feature: CAMARA Device reachability status API, v1.1.0-rc.2 - Operation getReachabilityStatus
  ...
  Background: Common getReachabilityStatus setup
    Given the resource "{api-root}/device-reachability-status/v1rc2/retrieve" set as base-url
